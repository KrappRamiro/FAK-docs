...
|---|---|---|---|
| [SHT31](temperatura-humedad/sht31.md) | $\pm 0.2\,°\text{C}$ | $\pm 2\%$ | Tolera 5V, generación 3 |
| [SHT40](temperatura-humedad/sht40.md) | $\pm 0.2\,°\text{C}$ | $\pm 1.8\%$ | Heater 3 niveles |
| [SHT41](temperatura-humedad/sht41.md) | $\pm 0.2\,°\text{C}$ | $\pm 1.8\%$ | Misma silicon que SHT40, factory cal más rigurosa |
| [SHT45](temperatura-humedad/sht45.md) | **$\pm 0.1\,°\text{C}$** | **$\pm 1\%$** | Para publicación. Variante con filtro PTFE para invernadero. |
| [SHTC3](temperatura-humedad/shtc3.md) | $\pm 0.2\,°\text{C}$ | $\pm 2\%$ | Footprint ultra-compacto |
