...
> No están deprecated: WROVER-E, WROVER-IE y S2-WROVER siguen en catálogo oficial de Espressif. Sí es cierto que para [S3](../socs/esp32-s3.md) y posteriores no existe variante WROVER, porque la PSRAM va dentro del [WROOM](./wroom.md) con el sufijo `R` (ej. `WROOM-1-N16R8` = WROOM con 16 MB flash + 8 MB PSRAM).
