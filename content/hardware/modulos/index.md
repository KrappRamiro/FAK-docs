...
El módulo es el chip empaquetado con flash, PSRAM (opcional) y antena, en un package metálico solderable. Es lo que va adentro del [DevKit](../devkits/index.md).
...
| `U` o `IE` | Conector **U.FL** para antena externa - requerido dentro de gabinetes metálicos o con relleno de carbono |
